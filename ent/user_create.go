...
func (_c *UserCreate) AddQuestionnaireIDs(ids ...uuid.UUID) *UserCreate {
	_c.mutation.AddQuestionnaireIDs(ids...)
	return _c
}

// AddQuestionnaires adds the "questionnaires" edges to the Questionnaire entity.
func (_c *UserCreate) AddQuestionnaires(v ...*Questionnaire) *UserCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _c.AddQuestionnaireIDs(ids...)
}
...
func (_c *UserCreate) AddMemberships(v ...*Member) *UserCreate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := _c.mutation.QuestionnairesIDs(); len(nodes) > 0 {
