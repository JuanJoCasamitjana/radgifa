...
func (e UserEdges) QuestionnairesOrErr() ([]*Questionnaire, error) {
	if e.loadedTypes[0] {
...
// was not loaded in eager-loading.
func (e UserEdges) MembershipsOrErr() ([]*Member, error) {
	if e.loadedTypes[1] {
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldName, user.FieldUsername, user.FieldDisplayName:
...
func (_m *User) QueryQuestionnaires() *QuestionnaireQuery {
	return NewUserClient(_m.config).QueryQuestionnaires(_m)
}

// QueryMemberships queries the "memberships" edge of the User entity.
func (_m *User) QueryMemberships() *MemberQuery {
