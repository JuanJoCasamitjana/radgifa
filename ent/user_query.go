...
type UserQuery struct {
	...
	withQuestionnaires *QuestionnaireQuery
	withMemberships    *MemberQuery
...
func (_q *UserQuery) QueryQuestionnaires() *QuestionnaireQuery {
...
func (_q *UserQuery) QueryMemberships() *MemberQuery {
...
func (_q *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withQuestionnaires: _q.withQuestionnaires.Clone(),
...
func (_q *UserQuery) WithQuestionnaires(opts ...func(*QuestionnaireQuery)) *UserQuery {
	query := (&QuestionnaireClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withQuestionnaires = query
	return _q
}
...
func (_q *UserQuery) WithMemberships(opts ...func(*MemberQuery)) *UserQuery {
	query := (&MemberClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withQuestionnaires; query != nil {
		if err := _q.loadQuestionnaires(ctx, query, nodes,
			func(n *User) { n.Edges.Questionnaires = []*Questionnaire{} },
			func(n *User, e *Questionnaire) { n.Edges.Questionnaires = append(n.Edges.Questionnaires, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withMemberships; query != nil {
		if err := _q.loadMemberships(ctx, query, nodes,
			func(n *User) { n.Edges.Memberships = []*Member{} },
			func(n *User, e *Member) { n.Edges.Memberships = append(n.Edges.Memberships, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadQuestionnaires(ctx context.Context, query *QuestionnaireQuery, nodes []*User, init func(*User), assign func(*User, *Questionnaire)) error {
...
func (_q *UserQuery) loadMemberships(ctx context.Context, query *MemberQuery, nodes []*User, init func(*User), assign func(*User, *Member)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
